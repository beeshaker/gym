...
urlpatterns = [
    ...
    path('log/<int:session_id>/exercise/<int:we_id>/edit-set/<int:set_id>/', workout_views.edit_set, name='gym_edit_set'),
    path('log/<int:session_id>/exercise/<int:we_id>/remove/', workout_views.remove_exercise, name='gym_remove_exercise'),
